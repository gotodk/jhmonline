<%@ Page Title="" Language="C#" MasterPageFile="~/adminht/MasterPageMain.master" AutoEventWireup="true" CodeFile="edit_qbj_myqb_liuyan.aspx.cs" Inherits="huodong_edit_qbj_myqb_liuyan" %>
      ...
      <div class="row"><div class="col-xs-12 col-lg-6 col-md-6 col-sm-6">
            ...
            <div class="widget-box">
											<div class="widget-header widget-header-small">
												<h5 class="widget-title lighter">我要针对此情报留言</h5>
											</div>
														...
														<div class="row">
															<div class="col-xs-12 col-sm-12">
																<div class="input-group">
                                                                    ...
                                                                    <hr />
                                                                    <input type="text" class="form-control search-query" id="jianduanliuyan" name="jianduanliuyan" placeholder="输入简短留言">
																	<span class="input-group-btn">
																		<button type="button" class="btn btn-danger btn-sm" id="lygo">
    ...
    <uc1:wuc_script runat="server" ID="wuc_script" />
        ...
        <script type="text/javascript">
            jQuery(function ($) {
                ...
                //给预约按钮添加事件，调用批量操作的接口
                $(document).on('click', "#lygo", function () {

                    begin_ajax("kaishily", getUrlParam("idforedit"), "170524000079")
