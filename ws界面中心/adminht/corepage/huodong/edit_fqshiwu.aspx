<%@ Page Title="" Language="C#" MasterPageFile="~/adminht/MasterPageMain.master" AutoEventWireup="true" CodeFile="edit_fqshiwu.aspx.cs" Inherits="huodong_edit_fqshiwu" %>
    ...
    <uc1:wuc_script runat="server" ID="wuc_script" />
        ...
        <script type="text/javascript">
            ...
            function addok_after_msgshow(msg) {
                if (msg == "成功发起事务")
                {
                    bootbox.alert("发起新事务成功！");
                    setTimeout("window.location.href = '/adminht/corepage/huodong/list_mysw_fq.aspx'; ", 2000);
