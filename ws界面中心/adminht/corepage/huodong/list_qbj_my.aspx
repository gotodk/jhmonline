<%@ Page Title="" Language="C#" MasterPageFile="~/adminht/MasterPageMain.master" AutoEventWireup="true" CodeFile="list_qbj_my.aspx.cs" Inherits="huodong_list_qbj_my" %>
    ...
    <uc1:wuc_script_onlygrid runat="server" ID="wuc_script_onlygrid" />
     ...
     <script type="text/javascript">
      ...
      var nowloginuser = "<%=UserSession.唯一键%>";
         $("#zheshiliebiaoquyu").attr('teshuwhere', " Qfbr='" + nowloginuser + "'  ");
