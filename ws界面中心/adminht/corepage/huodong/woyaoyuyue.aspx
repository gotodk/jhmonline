<%@ Page Title="" Language="C#" MasterPageFile="~/adminht/MasterPageMain.master" AutoEventWireup="true" CodeFile="woyaoyuyue.aspx.cs" Inherits="huodong_woyaoyuyue" %>
    ...
    <div class="row"><div class="col-xs-12 col-lg-6 col-md-6 col-sm-6">
            ...
            <div class="widget-box">
											<div class="widget-header widget-header-small">
												<h5 class="widget-title lighter">我要预约</h5>
											</div>
														...
														<div class="row">
															<div class="col-xs-12 col-sm-12">
																<div class="input-group">
																	...
																	<input type="text" class="form-control search-query" id="yaoqiu" name="yaoqiu" placeholder="输入其他建议">
																	<span class="input-group-btn">
																		<button type="button" class="btn btn-danger btn-sm" id="yuyuego">
    ...
    <uc1:wuc_script runat="server" ID="wuc_script" />
        ...
        <script type="text/javascript">
            jQuery(function ($) {
                ...
                //给预约按钮添加事件，调用批量操作的接口
                $(document).on('click', "#yuyuego", function () {

                    begin_ajax("kaishiyuyue", getUrlParam("idforedit"), "170523000075")
