<%@ Page Title="" Language="C#" MasterPageFile="~/adminht/MasterPageMain.master" AutoEventWireup="true" CodeFile="list_qbj_myly.aspx.cs" Inherits="huodong_list_qbj_myly" %>
    ...
    <uc1:wuc_script_onlygrid runat="server" ID="wuc_script_onlygrid" />
     ...
     <script type="text/javascript">
       ...
       var nowloginuser = "<%=UserSession.唯一键%>";
         $("#zheshiliebiaoquyu").attr('teshuwhere', " Llyr='" + nowloginuser + "'  ");
