<%@ Page Title="" Language="C#" MasterPageFile="~/adminht/MasterPageMain.master" AutoEventWireup="true" CodeFile="list_gxbgjlb.aspx.cs" Inherits="bangong_list_gxbgjlb" %>
    ...
    <uc1:wuc_script_onlygrid runat="server" ID="wuc_script_onlygrid" />
     ...
     <script type="text/javascript">
         if (getUrlParam("my") == "my")
         {
             ...
             $("#zheshiliebiaoquyu").attr('teshuwhere', " G_gxr='" + nowloginuser + "'   ");
         }
