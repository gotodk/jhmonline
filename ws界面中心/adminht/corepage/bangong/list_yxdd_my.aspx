<%@ Page Title="" Language="C#" MasterPageFile="~/adminht/MasterPageMain.master" AutoEventWireup="true" CodeFile="list_yxdd_my.aspx.cs" Inherits="bangong_list_yxdd_my" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="sp_script" runat="Server">
    <uc1:wuc_script_onlygrid runat="server" ID="wuc_script_onlygrid" />
     ...
     <script type="text/javascript">
         ...
         $("#zheshiliebiaoquyu").attr('teshuwhere', " Yaddren='" + nowloginuser + "'   ");
