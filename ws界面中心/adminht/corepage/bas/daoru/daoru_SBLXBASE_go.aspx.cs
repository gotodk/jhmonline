...
public partial class corepage_daoru_SBLXBASE_go : System.Web.UI.Page
{
    ...
    /// 列检查
    /// </summary>
    public string liejiancha = "设备编号,设备名称,设备型号,单位,成本价,保修期限,保养周期,产品说明,销售价格,生产厂家,ERP编号,设备状态,备注";
    public string drbj = "设备物料表导入";
    #endregion
