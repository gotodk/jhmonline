...
public class NoReSet_170524000073
{
    ...
    public DataSet NRS_EDIT(DataTable parameter_forUI)
    {
        ...
        alsql.Add("UPDATE ZZZ_qingbao set  Qleixing=@Qleixing, Qtitle=@Qtitle, Qlookjb=@Qlookjb, Qlookgxd=@Qlookgxd, Qneirong=@Qneirong, Qkey=@Qkey, Qlxfs=@Qlxfs, Qzt=@Qzt,Qxgsj=getdate() where QID=@QID");
